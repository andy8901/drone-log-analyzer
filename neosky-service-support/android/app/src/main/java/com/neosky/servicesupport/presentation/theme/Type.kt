...
// Uses the platform default font family (no custom font download required); a distinctive
// weight/tracking rhythm keeps the aviation-professional feel without extra dependencies.
val NeoSkyTypography = Typography(
    displayLarge = TextStyle(fontFamily = FontFamily.Default, fontWeight = FontWeight.SemiBold, fontSize = 57.sp, lineHeight = 64.sp),
