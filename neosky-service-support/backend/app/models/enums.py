...
user_role_enum = PGEnum(
    "customer", "service_engineer", "admin",
    name="user_role", create_type=False,
)

drone_status_enum = PGEnum(
    "active", "under_service", "grounded", "retired", "lost_stolen",
    name="drone_status", create_type=False,
)

component_type_enum = PGEnum(
    "battery", "controller_gcs", "payload", "propeller",
    "motor", "esc", "flight_controller", "other",
    name="component_type", create_type=False,
)
...
attachment_type_enum = PGEnum(
    "photo", "video", "document", "log",
    name="attachment_type", create_type=False,
)

flight_result_enum = PGEnum(
    "successful", "aborted", "crashed", "partial",
    name="flight_result", create_type=False,
)
...
warranty_type_enum = PGEnum(
    ...
    name="warranty_type", create_type=False,
)
